    ...
    <div id="wrapper" class="container">
        ...
        <div id="contenido" class="row">
            <div class="col-8">
                <section>
                <h2>Tren</h2>
                    <img src="images/tren.jfif" class="card-img-top" alt="...">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam consectetur eaque sit quo optio animi molestias repellat doloribus perferendis! Cumque facere autem vel quibusdam libero voluptatem commodi repellat adipisci ipsam.</p>

                    <div class="embed-responsive embed-responsive-21by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/jfMs2ZV9J4c" allowfullscreen></iframe>
</div>
                </section>
            </div>
            <div class="col">
                <aside>
                    ...
                    <p></p>
                    <h3>Ruta de tren</h3>
                    <img src="images/rutatren.jfif" class="card-img-top" alt="...">
                </aside>
            </div>
        </div>
